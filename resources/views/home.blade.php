...
<section class="contents forImage">
  ...
  <div class="container">
              {{-- First form --}}
              <form action="{{('/home')}}" method="GET" class="topForm">
                <section class="row">
                    <div class="form-group  col-md-10">
                      <input type="text" name="keyword"  class=" form-control" placeholder="ここにキーワードを入力">
                    </div>
                    {{-- Second form --}}
                    ...
                    {{-- Third form --}}
                    <div class="form-group col-md-5">
                        <label for="location">会場タイプで検索</label>
                    ...
                    <div class="form-group col-md-2 searchBtn">
